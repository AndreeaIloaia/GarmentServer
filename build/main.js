...
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./store */ "./src/auth/store.js");
...
const createUser = async (user, response) => {
  try {
    await _store__WEBPACK_IMPORTED_MODULE_2__["default"].insert(user);
    response.body = {
...
router.post('/login', async ctx => {
  ...
  const user = await _store__WEBPACK_IMPORTED_MODULE_2__["default"].findOne({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./router */ "./src/garment/router.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "router", function() { return _router__WEBPACK_IMPORTED_MODULE_0__["router"]; });
...
/***/ "./src/garment/store.js":
/*!******************************!*\
  !*** ./src/garment/store.js ***!
  \******************************/
/*! exports provided: GarmentStore, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GarmentStore", function() { return GarmentStore; });
/* harmony import */ var nedb_promise__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! nedb-promise */ "nedb-promise");
/* harmony import */ var nedb_promise__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(nedb_promise__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony default export */ __webpack_exports__["default"] = (new GarmentStore({
  filename: './database/garments.json',
  autoload: true
}));
...
/* harmony import */ var _garment__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./garment */ "./src/garment/index.js");
...
const prefix = '/api'; //public routes

const publicApiRoutes = new koa_router__WEBPACK_IMPORTED_MODULE_3___default.a({
  prefix
});
publicApiRoutes.use('/auth', _auth__WEBPACK_IMPORTED_MODULE_6__["router"].routes());
app.use(publicApiRoutes.routes()).use(publicApiRoutes.allowedMethods());
app.use(koa_jwt__WEBPACK_IMPORTED_MODULE_8___default()(_utils__WEBPACK_IMPORTED_MODULE_5__["jwtConfig"])); //protected routes
...
module.exports = __webpack_require__(/*! E:\Anul_III\Sem_I\pdm\Garment\server\src/index.js */"./src/index.js");
